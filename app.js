...
$(function() {
    $("#carForm")
        .on("submit", function(event) {
            ...
            var newCar = new carObject(make, model, year, color,
                rating, price);
            ...
            $("div:last")
                .addClass("carDisplay")
                .prepend("<h4>car " + carNum +
                    "</h4><button class=\"remove\">Remove</button>"
                );
            ...
            $("article")
                .find("ul:last")
                .append("<li>Make: " + newCar.make + "</li>");
            $("article")
                .find("ul:last")
                .append("<li>Model: " + newCar.model + "</li>");
            $("article")
                .find("ul:last")
                .append("<li>Year: " + newCar.year + "</li>");
            $("article")
                .find("ul:last")
                .append("<li>Color: " + newCar.color + "</li>");
            $("article")
                .find("ul:last")
                .append("<li>Rating: " + newCar.rating + "</li>");
            $("article")
                .find("ul:last")
                .append("<li>Price: " + newCar.price + "</li>");
        });
